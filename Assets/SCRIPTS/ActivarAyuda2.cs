...
public class ActivarAyuda2 : MonoBehaviour {
    private int cont, tiempo, tiempoBloqueoAyuda, regreso;
    private float contAyuda, contBloqueoAyuda, reg;
    private Renderer orion, orion1, orion2, orion3, orion4, orion5, orion6, orion7, orion8;
    ...
    void Start()
    {
        ...
        orion7 = GameObject.Find("ayuda7").GetComponent<Renderer>();
        orion8 = GameObject.Find("ayuda8").GetComponent<Renderer>();
    }
    ...
    void Update()
    {
        ...
        if (tiempo >= 10)
        {
            ...
            orion7.enabled = false;
            orion8.enabled = false;
            contAyuda = 0;
            contBloqueoAyuda = 0;
            tiempo = 0;
            cont = -1;
